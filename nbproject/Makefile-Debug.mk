...
${OBJECTDIR}/FloydWarshall.o: FloydWarshall.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -Werror -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/FloydWarshall.o FloydWarshall.c

${OBJECTDIR}/FloydWarshallFile.o: FloydWarshallFile.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -Werror -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/FloydWarshallFile.o FloydWarshallFile.c

${OBJECTDIR}/Stack.o: Stack.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -Werror -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Stack.o Stack.c
...
${TESTDIR}/tests/TestFloydWarshall.o: tests/TestFloydWarshall.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -g -Werror -I. -std=c11 -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/TestFloydWarshall.o tests/TestFloydWarshall.c


${TESTDIR}/tests/TestFloydWarshallFile.o: tests/TestFloydWarshallFile.c 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.c) -g -Werror -I. -std=c11 -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/TestFloydWarshallFile.o tests/TestFloydWarshallFile.c
...
${OBJECTDIR}/FloydWarshall_nomain.o: ${OBJECTDIR}/FloydWarshall.o FloydWarshall.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -Werror -std=c11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/FloydWarshall_nomain.o FloydWarshall.c;\
	else  \
...
${OBJECTDIR}/FloydWarshallFile_nomain.o: ${OBJECTDIR}/FloydWarshallFile.o FloydWarshallFile.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -Werror -std=c11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/FloydWarshallFile_nomain.o FloydWarshallFile.c;\
	else  \
...
${OBJECTDIR}/Stack_nomain.o: ${OBJECTDIR}/Stack.o Stack.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -Werror -std=c11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Stack_nomain.o Stack.c;\
	else  \
